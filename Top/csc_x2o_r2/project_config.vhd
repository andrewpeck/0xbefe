...
package project_config is
    ...
    constant CFG_DMB_CONFIG_ARR : t_dmb_config_arr_per_slr(0 to CFG_NUM_SLRS - 1)(0 to CFG_DAQ_MAX_DMBS - 1) := (
        ...
        ( ------------------------------------------------ SLR0 ------------------------------------------------
            ...
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (16, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB8, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (17, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB9, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (18, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB10, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (19, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB11, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (20, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB12, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (21, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB13, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (22, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB14, SLR 0
            (dmb_type => DMB, num_fibers => 1, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (23, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS, CFG_BOARD_MAX_LINKS)), -- DMB15, SLR 0
        ...
        1 =>
        ( ------------------------------------------------ SLR1 ------------------------------------------------
            (dmb_type => ODMB7, num_fibers => 4, tx_fiber => CFG_BOARD_MAX_LINKS, rx_fibers => (4, 5, 6, 7)), -- DMB0, SLR 1
    ...
    constant CFG_GBT_LINK_CONFIG_ARR : t_gbt_link_config_arr_per_slr(0 to CFG_NUM_SLRS - 1)(0 to CFG_MAX_GBTS - 1) := (
        ...
        1 =>
        ( ------------------------------------------------ SLR1 ------------------------------------------------
            (tx_fiber => 4, rx_fiber => CFG_BOARD_MAX_LINKS), -- GBT0, SLR 1
            (tx_fiber => 5, rx_fiber => CFG_BOARD_MAX_LINKS), -- GBT1, SLR 1
            (tx_fiber => 6, rx_fiber => CFG_BOARD_MAX_LINKS), -- GBT2, SLR 1
            (tx_fiber => 7, rx_fiber => CFG_BOARD_MAX_LINKS), -- GBT3, SLR 1
            others => (tx_fiber => CFG_BOARD_MAX_LINKS, rx_fiber => CFG_BOARD_MAX_LINKS)
        ),
        2 =>
        ( ------------------------------------------------ SLR2 ------------------------------------------------
...
--        );    
    ...
    constant CFG_MGT_LINK_CONFIG : t_mgt_config_arr := (
        ----------------------------- quad 120 (SLR 0) -----------------------------
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_DMB_GBE_156          , qpll_idx => 000, refclk0_idx => 00, refclk1_idx => 0, is_master => true , chbond_master => 0, ibert_inst => false), -- MGT 0 RX: SLR0 DMB 2 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 000, refclk0_idx => 00, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 1 RX: SLR0 DMB 5 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 000, refclk0_idx => 00, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 2 RX: SLR0 DMB 0 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 000, refclk0_idx => 00, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 3 RX: SLR0 DMB 3 chan 0
        ----------------------------- quad 121 (SLR 0) -----------------------------
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_DMB_GBE_156          , qpll_idx => 004, refclk0_idx => 01, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 4 RX: SLR0 DMB 4 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 004, refclk0_idx => 01, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 5 RX: SLR0 DMB 1 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 004, refclk0_idx => 01, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 6 RX: SLR0 DMB 6 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 004, refclk0_idx => 01, refclk1_idx => 0, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 7 RX: SLR0 DMB 7 chan 0
        ----------------------------- quad 122 (SLR 0) -----------------------------
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_DMB_GBE_156          , qpll_idx => 008, refclk0_idx => 02, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 8 RX: SLR0 DMB 11 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 008, refclk0_idx => 02, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 9 RX: SLR0 DMB 12 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 008, refclk0_idx => 02, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 10 RX: SLR0 DMB 9 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 008, refclk0_idx => 02, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 11 RX: SLR0 DMB 8 chan 0
        ----------------------------- quad 123 (SLR 0) -----------------------------
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_DMB_GBE_156          , qpll_idx => 012, refclk0_idx => 03, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 12 RX: SLR0 DMB 15 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 012, refclk0_idx => 03, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 13 RX: SLR0 DMB 10 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 012, refclk0_idx => 03, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 14 RX: SLR0 DMB 13 chan 0
        (mgt_type => CFG_MGT_DMB      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 012, refclk0_idx => 03, refclk1_idx => 1, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 15 RX: SLR0 DMB 14 chan 0
        ----------------------------- quad 126 (SLR 1) -----------------------------
        (mgt_type => CFG_MGT_TTC      , qpll_inst_type => QPLL_LPGBT                , qpll_idx => 016, refclk0_idx => 04, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 16
        (mgt_type => CFG_MGT_TTC      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 016, refclk0_idx => 04, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 17
        (mgt_type => CFG_MGT_TTC      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 016, refclk0_idx => 04, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 18
        (mgt_type => CFG_MGT_TTC      , qpll_inst_type => QPLL_NULL                 , qpll_idx => 016, refclk0_idx => 04, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 19
        ----------------------------- quad 127 (SLR 1) -----------------------------
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_ODMB57_156           , qpll_idx => 020, refclk0_idx => 05, refclk1_idx => 3, is_master => true , chbond_master => 23, ibert_inst => false), -- MGT 20 TX: SLR1 GBT chan 3 RX: SLR1 ODMB 0 chan 3
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 020, refclk0_idx => 05, refclk1_idx => 3, is_master => false, chbond_master => 23, ibert_inst => false), -- MGT 21 TX: SLR1 GBT chan 2 RX: SLR1 ODMB 0 chan 2
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 020, refclk0_idx => 05, refclk1_idx => 3, is_master => false, chbond_master => 23, ibert_inst => false), -- MGT 22 TX: SLR1 GBT chan 1 RX: SLR1 ODMB 0 chan 1
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 020, refclk0_idx => 05, refclk1_idx => 3, is_master => false, chbond_master => 23, ibert_inst => false), -- MGT 23 TX: SLR1 GBT chan 0 RX: SLR1 ODMB 0 chan 0
        ----------------------------- quad 128 (SLR 2) -----------------------------
        (mgt_type => CFG_MGT_TYPE_NULL, qpll_inst_type => QPLL_NULL                 , qpll_idx => 024, refclk0_idx => 06, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 24
        (mgt_type => CFG_MGT_TYPE_NULL, qpll_inst_type => QPLL_NULL                 , qpll_idx => 024, refclk0_idx => 06, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 25
        (mgt_type => CFG_MGT_TYPE_NULL, qpll_inst_type => QPLL_NULL                 , qpll_idx => 024, refclk0_idx => 06, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 26
        (mgt_type => CFG_MGT_TYPE_NULL, qpll_inst_type => QPLL_NULL                 , qpll_idx => 024, refclk0_idx => 06, refclk1_idx => 3, is_master => false, chbond_master => 0, ibert_inst => false), -- MGT 27
        ----------------------------- quad 129 (SLR 2) -----------------------------
        ...
        ----------------------------- quad 134 (SLR 3) -----------------------------
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_ODMB57_156           , qpll_idx => 048, refclk0_idx => 12, refclk1_idx => 6, is_master => false, chbond_master => 53, ibert_inst => false), -- MGT 48 RX: SLR3 ODMB 1 chan 3
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 048, refclk0_idx => 12, refclk1_idx => 6, is_master => false, chbond_master => 49, ibert_inst => false), -- MGT 49 RX: SLR3 ODMB 2 chan 0
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 048, refclk0_idx => 12, refclk1_idx => 6, is_master => false, chbond_master => 49, ibert_inst => false), -- MGT 50 RX: SLR3 ODMB 2 chan 1
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 048, refclk0_idx => 12, refclk1_idx => 6, is_master => false, chbond_master => 49, ibert_inst => false), -- MGT 51 RX: SLR3 ODMB 2 chan 2
        ----------------------------- quad 135 (SLR 3) -----------------------------
        ...
        ----------------------------- quad 233 (SLR 3) -----------------------------
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_ODMB57_156           , qpll_idx => 108, refclk0_idx => 27, refclk1_idx => 15, is_master => false, chbond_master => 109, ibert_inst => false), -- MGT 108 RX: SLR3 ODMB 5 chan 1
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 108, refclk0_idx => 27, refclk1_idx => 15, is_master => false, chbond_master => 109, ibert_inst => false), -- MGT 109 RX: SLR3 ODMB 5 chan 0
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 108, refclk0_idx => 27, refclk1_idx => 15, is_master => false, chbond_master => 109, ibert_inst => false), -- MGT 110 RX: SLR3 ODMB 5 chan 3
        (mgt_type => CFG_MGT_ODMB57   , qpll_inst_type => QPLL_NULL                 , qpll_idx => 108, refclk0_idx => 27, refclk1_idx => 15, is_master => false, chbond_master => 109, ibert_inst => false), -- MGT 111 RX: SLR3 ODMB 5 chan 2
        ----------------------------- quad 234 (SLR 3) -----------------------------
