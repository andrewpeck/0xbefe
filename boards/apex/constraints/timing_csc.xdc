...
set_clock_groups -asynchronous -group $dmb_clks -group $eth_clks -group $gbt_clks -group $gbt_link_rx_clks -group $slink_clks -group $daq_clks -group $slow_ctrl_clks
