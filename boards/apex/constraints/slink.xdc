# MGT location (quad 134, channel 2)
set_property LOC GTYE4_CHANNEL_X0Y30 [get_cells -hierarchical -filter name=~i_slink_rocket/i_slink_sender/*GTYE4_CHANNEL_PRIM_INST]
