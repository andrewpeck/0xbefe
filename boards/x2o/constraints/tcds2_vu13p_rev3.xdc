...
# quad 124 ch0 << this is used in rev2 with incorrect ARF6 cable connection
# NOTE: RX is inverted

#set_property PACKAGE_PIN BA45 [get_ports tcds2_mgt_tx_p]
#set_property PACKAGE_PIN BA46 [get_ports tcds2_mgt_rx_p] << this is incorrect, should be BA50!!!!

# quad 127 ch3 << this should be used on rev3, or rev2 with corrected ARF6 cable connection
# NOTE: no inversions

set_property PACKAGE_PIN AF43 [get_ports tcds2_mgt_tx_p]
set_property PACKAGE_PIN AF48 [get_ports tcds2_mgt_rx_p]
