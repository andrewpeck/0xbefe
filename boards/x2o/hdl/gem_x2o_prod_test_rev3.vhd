...
--        fake_gbt_master_clk <= clkout_160;
    ...
    -- in this test firmware just output the TTC40 clk on both refs
    i_lmk_ref0_buf : OBUFDS
        port map(
            O  => lmk_refclk_0_p,
            OB => lmk_refclk_0_n,
            I  => ttc_clks.clk_40
