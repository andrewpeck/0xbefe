...
package board_config_package is
    ...
    constant CFG_FIBER_TO_MGT_MAP : t_fiber_to_mgt_link_map := (
        ...
        (054, 042, true , true ), -- fiber 42 (SLR 3) -- TX not usable for sync links (refclk1 = 40MHz)
        ...
        --========= QSFP cage #12 =========--
        (055, 053, false, false), -- fiber 48 (SLR 3) -- TX and RX not usable for sync links (refclk1 = 40MHz)
        (048, 054, true , true ), -- fiber 49 (SLR 3) -- RX not usable for sync links (refclk1 = 40MHz)
        (049, 055, false, false), -- fiber 50 (SLR 3) -- RX not usable for sync links (refclk1 = 40MHz)
        (046, 048, true , true ), -- fiber 51 (SLR 3)
        --========= QSFP cage #13 =========--
        (051, 049, false, false), -- fiber 52 (SLR 3)
        (050, 050, true , true ), -- fiber 53 (SLR 3)
        (053, 051, false, false), -- fiber 54 (SLR 3) -- TX not usable for sync links (refclk1 = 40MHz)
        (052, 052, true , true ), -- fiber 55 (SLR 3) -- TX and RX not usable for sync links (refclk1 = 40MHz)
        --========= QSFP cage #14 =========--
