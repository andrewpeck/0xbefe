...
package board_config_package is
    ...
    constant CFG_BOARD_MAX_LINKS    : integer := 120; --24; --120;

    ------------ DAQ configuration ------------
    constant CFG_DAQ_MAX_DMBS               : integer := 24; -- the number of DMBs that are supported by the DAQ module (the CFG_NUM_DMBS can be less than or equal to this number)
    constant CFG_MAX_GBTS                   : integer := 8; -- max number of GBT links that can be supported by this board
    
    constant CFG_DAQ_EVTFIFO_DEPTH          : integer := 512; --4096;
    constant CFG_DAQ_EVTFIFO_PROG_FULL_SET  : integer := 384; --3072;
    constant CFG_DAQ_EVTFIFO_PROG_FULL_RESET: integer := 256; --2047;
    constant CFG_DAQ_EVTFIFO_DATA_CNT_WIDTH : integer := 9; --12;
    
    constant CFG_DAQ_INFIFO_DEPTH           : integer := 8192; --16384;
    constant CFG_DAQ_INFIFO_PROG_FULL_SET   : integer := 6144;  --12288;
    constant CFG_DAQ_INFIFO_PROG_FULL_RESET : integer := 4096;  --8192;
    constant CFG_DAQ_INFIFO_DATA_CNT_WIDTH  : integer := 13; --14;
    ...
    constant CFG_DAQ_OUTPUT_DEPTH           : integer := 262144; --524288; --1048576;  --8192;
    constant CFG_DAQ_OUTPUT_PROG_FULL_SET   : integer := 196608; --393216; --786432;   --4045;
    constant CFG_DAQ_OUTPUT_PROG_FULL_RESET : integer := 131072; --262144; --524285;   --1365;
    constant CFG_DAQ_OUTPUT_DATA_CNT_WIDTH  : integer := 18; --13; -- max is 19

    constant CFG_DAQ_L1AFIFO_DEPTH          : integer := 8192;
    constant CFG_DAQ_L1AFIFO_PROG_FULL_SET  : integer := 6144;
    constant CFG_DAQ_L1AFIFO_PROG_FULL_RESET: integer := 4096;
    constant CFG_DAQ_L1AFIFO_DATA_CNT_WIDTH : integer := 13; -- max is 13
    ...
    constant CFG_FIBER_TO_MGT_MAP : t_fiber_to_mgt_link_map := (
        --========= QSFP cage #0 =========--
        (019, 019, false, true ), -- fiber 0 (SLR 1)
        (018, 018, false, false), -- fiber 1 (SLR 1)
        (017, 017, false, true ), -- fiber 2 (SLR 1)
        (016, 016, false, false), -- fiber 3 (SLR 1)
        --========= QSFP cage #1 =========--
        (023, 023, false, true ), -- fiber 4 (SLR 1)
        (022, 022, false, false), -- fiber 5 (SLR 1)
        (021, 021, false, true ), -- fiber 6 (SLR 1)
        (020, 020, false, false), -- fiber 7 (SLR 1)
        --========= QSFP cage #2 =========--
        (002, 002, false, false), -- fiber 8 (SLR 0)
        (003, 005, true , true ), -- fiber 9 (SLR 0)
        (004, 000, false, false), -- fiber 10 (SLR 0)
        (005, 003, true , true ), -- fiber 11 (SLR 0)
        --========= QSFP cage #3 =========--
        (000, 004, false, false), -- fiber 12 (SLR 0)
        (001, 001, true , true ), -- fiber 13 (SLR 0)
        (006, 006, false, false), -- fiber 14 (SLR 0)
        (009, 007, true , true ), -- fiber 15 (SLR 0)
        --========= QSFP cage #4 =========--
        (011, 011, true , true ), -- fiber 16 (SLR 0)
        (010, 010, false, false), -- fiber 17 (SLR 0)
        (007, 013, false, true ), -- fiber 18 (SLR 0)
        (008, 008, false, false), -- fiber 19 (SLR 0)
        --========= QSFP cage #5 =========--
        (015, 009, true , true ), -- fiber 20 (SLR 0)
        (014, 014, false, false), -- fiber 21 (SLR 0)
        (013, 015, true , true ), -- fiber 22 (SLR 0)
        (012, 012, true , false), -- fiber 23 (SLR 0)
        --========= QSFP cage #6 =========--
