...
SOT_LOCS = ((0, 127), (0, 167), (1, 129), (1, 123), (2, 121), (2, 131), (0, 163), (1, 101),
            (0, 147), (0,  13), (0, 123), (0, 115), (2, 143), (2, 163), (2,  63), (2,  67),
            (0, 139), (0,  15), (0, 107), (0, 111), (1,   1), (1,   5), (2,  51), (1,  29),)
...
for rx_type in ("sot", "sbit"):
    ...
    for i in range(imax):
        ...
        f.write("# LOCs for %s Input #%d (X%dY%d)\n" % (rx_type.upper(),i,x0,y0))
