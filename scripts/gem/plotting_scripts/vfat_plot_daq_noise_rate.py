...
if __name__ == "__main__":
    ...
    for vfat in noise_result:
        ...
        if numVfats == 1:
            ...
            ax1.text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax1.transAxes)
            ...
            ax3.text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax3.transAxes)
            ...
            ax4.text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax4.transAxes)
            ax5.set_xlabel("Channel", loc='right', fontsize=18)
            ax5.set_ylabel("Threshold (DAC)", loc='top', fontsize=18)
            ...
            cbar5.ax.set_ylabel("Channel rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5.text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=18, transform=ax5.transAxes)
        elif numVfats <= 3:
            ...
            ax1[vfatCnt0].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax1[vfatCnt0].transAxes)
            ...
            ax3[vfatCnt0].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=22, transform=ax3[vfatCnt0].transAxes)
            ...
            ax4[vfatCnt0].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=22, transform=ax4[vfatCnt0].transAxes)
            ax5[vfatCnt0].set_xlabel("Channel", loc='right', fontsize=18)
            ax5[vfatCnt0].set_ylabel("Threshold (DAC)", loc='top', fontsize=18)
            ...
            cbar5[vfatCnt0].ax.set_ylabel("Channel rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[vfatCnt0].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=18, transform=ax5[vfatCnt0].transAxes)
        elif numVfats <= 6:
            ...
            ax1[int(vfatCnt0/3), vfatCnt0%3].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax1[int(vfatCnt0/3), vfatCnt0%3].transAxes)
            ...
            ax3[int(vfatCnt0/3), vfatCnt0%3].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax3[int(vfatCnt0/3), vfatCnt0%3].transAxes)
            ...
            ax4[int(vfatCnt0/3), vfatCnt0%3].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax4[int(vfatCnt0/3), vfatCnt0%3].transAxes)
            ax5[int(vfatCnt0/3), vfatCnt0%3].set_xlabel("Channel", loc='right', fontsize=18)
            ax5[int(vfatCnt0/3), vfatCnt0%3].set_ylabel("Threshold (DAC)", loc='top', fontsize=18)
            ...
            cbar5[int(vfatCnt0/3), vfatCnt0%3].ax.set_ylabel("Channel rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[int(vfatCnt0/3), vfatCnt0%3].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=18, transform=ax5[int(vfatCnt0/3), vfatCnt0%3].transAxes)
        else:
            ...
            ax1[int(vfatCnt0/6), vfatCnt0%6].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax1[int(vfatCnt0/6), vfatCnt0%6].transAxes)
            ...
            ax3[int(vfatCnt0/6), vfatCnt0%6].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=23, transform=ax3[int(vfatCnt0/6), vfatCnt0%6].transAxes)
            ...
            ax4[int(vfatCnt0/6), vfatCnt0%6].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=23, transform=ax4[int(vfatCnt0/6), vfatCnt0%6].transAxes)
            ax5[int(vfatCnt0/6), vfatCnt0%6].set_xlabel("Channel", loc='right', fontsize=18)
            ax5[int(vfatCnt0/6), vfatCnt0%6].set_ylabel("Threshold (DAC)", loc='top', fontsize=18)
            ...
            cbar5[int(vfatCnt0/6), vfatCnt0%6].ax.set_ylabel("Channel rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[int(vfatCnt0/6), vfatCnt0%6].text(-0.02, 1.01, 'Preliminary',fontstyle='italic', fontsize=18, transform=ax5[int(vfatCnt0/6), vfatCnt0%6].transAxes)
        ...
        for channel in noise_result[vfat]:
            ...
            ax2[int(channel/8), channel%8].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax2[int(channel/8), channel%8].transAxes)
            
        #ax2.text(-0.14, 1.01, 'CMS', fontweight='bold', fontsize=26, transform=ax2.transAxes)
        #ax2.text(0.03, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax2.transAxes)
        fig2.tight_layout()
