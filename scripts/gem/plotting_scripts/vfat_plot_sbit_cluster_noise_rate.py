...
if __name__ == "__main__":
    ...
    for vfat in noise_result:
        ...
        if numVfats == 1:
            ...
            cbar5.ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar5[vfatCnt0].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar5[int(vfatCnt0/3), vfatCnt0%3].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar5[int(vfatCnt0/6), vfatCnt0%6].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16, loc='top')
