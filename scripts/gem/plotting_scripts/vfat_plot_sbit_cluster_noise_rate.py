...
if __name__ == "__main__":
    ...
    for vfat in noise_result:
        ...
        2d_plot_data = []
        2d_plot_data_x = []
        2d_plot_data_y = threshold
        for sbit in range(0,64):
            2d_plot_data_x.append(sbit)
        ...
        if numVfats == 1:
            ...
            cf5 = ax5.pcolormesh(2d_plot_data_x, 2d_plot_data_y, 2d_plot_data, cmap=cm.ocean_r, shading="nearest")
            ...
            cf5[vfatCnt0] = ax5[vfatCnt0].pcolormesh(2d_plot_data_x, 2d_plot_data_y, 2d_plot_data, cmap=cm.ocean_r, shading="nearest")
            ...
            cf5[int(vfatCnt0/3), vfatCnt0%3] = ax5[int(vfatCnt0/3), vfatCnt0%3].pcolormesh(2d_plot_data_x, 2d_plot_data_y, 2d_plot_data, cmap=cm.ocean_r, shading="nearest")
            ...
            cf5[int(vfatCnt0/6), vfatCnt0%6] = ax5[int(vfatCnt0/6), vfatCnt0%6].pcolormesh(2d_plot_data_x, 2d_plot_data_y, 2d_plot_data, cmap=cm.ocean_r, shading="nearest")
