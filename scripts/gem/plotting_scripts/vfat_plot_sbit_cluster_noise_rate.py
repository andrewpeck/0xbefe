...
if __name__ == "__main__":
    ...
    for vfat in noise_result:
        ...
        if numVfats == 1:
            ...
            ax1.text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=26, transform=ax1.transAxes)
            ...
            ax1[vfatCnt0].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=26, transform=ax1[vfatCnt0].transAxes)
            ...
            ax1[int(vfatCnt0/3), vfatCnt0%3].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=26, transform=ax1[int(vfatCnt0/3), vfatCnt0%3].transAxes)
            ...
            ax1[int(vfatCnt0/6), vfatCnt0%6].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=26, transform=ax1[int(vfatCnt0/6), vfatCnt0%6].transAxes)
