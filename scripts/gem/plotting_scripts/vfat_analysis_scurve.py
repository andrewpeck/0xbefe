...
def plot2Dhist(vfatList, directoryName, oh, scurve_result, slope_adc, intercept_adc, current_pulse_sf, mode):
    ...
    for vfat in scurve_result:
        ...
        if numVfats == 1:
            ...
            cbar1.ax.set_ylabel("Fired Events / Total Events", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar1[vfatCnt0].ax.set_ylabel("Fired Events / Total Events", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar1[int(vfatCnt0/3), vfatCnt0%3].ax.set_ylabel("Fired Events / Total Events", rotation=270, fontsize=18, labelpad=16, loc='top')
            ...
            cbar1[int(vfatCnt0/6), vfatCnt0%6].ax.set_ylabel("Fired Events / Total Events", rotation=270, fontsize=18, labelpad=16, loc='top')
