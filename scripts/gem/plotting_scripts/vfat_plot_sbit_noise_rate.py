...
if __name__ == "__main__":
    ...
    for vfat in noise_result:
        ...
        if numVfats == 1:
            ...
            ax5.set_xlabel("S-Bit", loc='right', fontsize=18)
            ...
            cbar5.ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[vfatCnt0].set_xlabel("S-Bit", loc='right', fontsize=18)
            ...
            cbar5[vfatCnt0].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[int(vfatCnt0/3), vfatCnt0%3].set_xlabel("S-Bit", loc='right', fontsize=18)
            ...
            cbar5[int(vfatCnt0/3), vfatCnt0%3].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16)
            ...
            ax5[int(vfatCnt0/6), vfatCnt0%6].set_xlabel("S-Bit", loc='right', fontsize=18)
            ...
            cbar5[int(vfatCnt0/6), vfatCnt0%6].ax.set_ylabel("S-Bit rate (Hz)", rotation=270, fontsize=18, labelpad=16)
        ...
        for sbit in noise_result[vfat]:
            ...
            ax2[int(sbit/8), sbit%8].text(-0.01, 1.01, 'Preliminary',fontstyle='italic', fontsize=24, transform=ax2[int(sbit/8), sbit%8].transAxes)
