...
if __name__ == "__main__":
    ...
    #ssh_command = "cd devel_scripts_update_0xbefe/0xbefe/scripts; source env.sh me0 cvp13 0; cd gem; python3 me0_lpgbt/qsfp_testing/voa_control.py -a 0"    
    ssh_command = "python3 Documents/voa_control.py -a 0"
