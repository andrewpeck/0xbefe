...
def scan_set_bitslip(system, oh_select, vfat_list, bitslip_list):
    ...
    for vfat in vfat_list:
        ...
        for elink in range(0,9):
            write_backend_reg(get_backend_node("BEFE.GEM.GEM_TESTS.QUESO_TEST.OH%d.VFAT%d.ELINK%d.ELINK_BITSLIP_0"%(oh_select, vfat, elink)), 0)
            queso_bitslip_nodes[vfat][elink] = get_backend_node("BEFE.GEM.GEM_TESTS.QUESO_TEST.OH%d.VFAT%d.ELINK%d.ELINK_BITSLIP_1"%(oh_select, vfat, elink))
