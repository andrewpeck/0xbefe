...
CONFIG_ME0_OH_GBT0_CONFIGS = [BEFE_SCRIPTS_DIR + "/resources/me0_boss_config_ohv*.txt"] * 12
CONFIG_ME0_OH_GBT1_CONFIGS = [BEFE_SCRIPTS_DIR + "/resources/me0_sub_config_ohv*.txt"] * 12
